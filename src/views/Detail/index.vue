          ...
          <div class="goodsDetail">
            ...
            <div class="priceArea">
              <div class="priceArea1">
                ...
                <div class="remark">
                  <i>累计评价</i>
                  <em>{{ parseInt(Math.random() * 10000) }}</em>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    // 改变状态
    handleCheck(value, AllData) {
      if (value.isCkecked === "1") return;
      AllData.forEach((item) => (item.isChecked = "0"));
      value.isChecked = "1";
    },
  },
  computed: {
  ...
  mounted() {
    this.reqProductDetail(this.$route.params.detailId);
  },
};
</script>
